...
public class ScriptParser extends Parser {
	...
	public static final int Equals = 1, Or = 2, And = 3, Not = 4, Add = 5, Sub = 6, Variable = 7, Hexa = 8, Int = 9,
			HexaOpen = 10, Comment = 11, WS = 12;
	public static final int RULE_parse = 0, RULE_block = 1, RULE_line = 2, RULE_assignVar = 3, RULE_notExpression = 4,
			RULE_operation = 5, RULE_hexaDisp = 6, RULE_integerDisp = 7;
	public static final String[] ruleNames = { "parse", "block", "line", "assignVar", "notExpression", "operation",
			"hexaDisp", "integerDisp" };

	private static final String[] _LITERAL_NAMES = { null, "'='", "'|'", "'&'", "'!'", "'+'", "'-'", null, null, null,
			"'0x'" };
	private static final String[] _SYMBOLIC_NAMES = { null, "Equals", "Or", "And", "Not", "Add", "Sub", "Variable",
			"Hexa", "Int", "HexaOpen", "Comment", "WS" };
	...
	public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\16A\4\2\t\2\4\3\t"
			...
			+ "\2\2\2:\67\3\2\2\2;\r\3\2\2\2<=\7\n\2\2=\17\3\2\2\2>?\7\13\2\2?\21\3\2" + "\2\2\7\27\33\"):";
